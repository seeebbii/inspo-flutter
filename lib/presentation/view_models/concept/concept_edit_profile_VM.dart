...
class ConceptEditProfileScreenVM extends ChangeNotifier {
  String oldUsername = '';
  ...
  final TextEditingController _deliveryPlatformController = TextEditingController();
  final TextEditingController _typeOfBusinessController = TextEditingController();
  ...
  TextEditingController get deliveryPlatformController => _deliveryPlatformController;
  TextEditingController get typeOfBusinessController => _typeOfBusinessController;
  TextEditingController get catagoryController => _catagoryController;
